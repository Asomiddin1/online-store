  ...
  return (
    <div className='flex flex-wrap sm:gap-5 px-[10px]  gap-8 justify-center relative right-[-14px] pt-[50px] mx-auto max-w-[1500px]'>
      {data.map(({ image, title, price, id }) => {
        return <div key={id} className="relative sm:w-[300px] mx-auto w-[330px]  sm:h-[350px] h-[390px] text-center bg-[rgba(224,224,224,0.95)] rounded px-6 py-[20px]">
